...
// 정서 어휘까지 폭넓게 깔아 둔다. (완전한 의미 이해는 아니고 큰 사전 — 필요한 낱말은 계속 추가)
const TAG_SYNONYMS: Record<string, string[]> = {
  '밤': [
    '밤', '야경', '심야', '한밤', '자정', '새벽', '달', '달빛', '보름달', '초승달', '별', '별빛', '은하수',
    '저녁', '어스름', '불야성', '어둠', '어두운', '그림자', '그늘', '촛불', '등불', '침묵', '적막',
    '눈물', '슬픔', '슬픈', '이별', '리별', '그리움', '그리워', '쓸쓸', '고독', '외로움', '외로운',
    '애수', '서글픈', '탄식', '잠들', '꿈길', '자장가',
    'night', 'moon', 'moonlight', 'midnight', 'star', 'dark', 'lonely', 'tears', 'sad',
  ],
  '낮': [
    '낮', '아침', '새아침', '해돋이', '해빛', '햇빛', '햇살', '태양', '광명', '새날',
    '빛나', '밝은', '환한', '눈부신', '찬란', '맑은', '청명', '활짝', '웃음', '미소', '명랑',
    '기쁨', '기쁜', '희망', '행복', '힘차게', '앞날', '미래', '푸른하늘', '창공',
    'morning', 'sunrise', 'sunshine', 'bright', 'happy', 'hope', 'smile',
  ],
  '노을': ['노을', '저녁놀', '놀빛', '석양', '황혼', '해질녘', '해질무렵', '붉은하늘', 'sunset', 'dusk'],
  '인공물': [
    '인공물', '도시', '거리', '건물', '다리', '탑', '기념비', '동상', '분수', '등대', '공장', '철길',
    '열차', '기차', '지하철', '전차', '광장', '고층', '살림집', '유원지', 'city', 'tower', 'bridge',
  ],
  '자연물': [
    '자연물', '자연', '강', '강변', '호수', '들', '벌판', '초원', '숲', '수림', '폭포', '바위',
    '시내물', '계곡', '들판', '언덕', 'nature', 'river', 'lake', 'forest', 'field',
  ],
  '바다': [
    '바다', '파도', '항구', '뱃길', '해안', '섬', '수평선', '갈매기', '돛', '어선', '만선', '푸른물',
    'sea', 'ocean', 'wave', 'sail',
  ],
  '산': ['산', '백두', '백두산', '금강', '금강산', '봉우리', '고지', '수림', '령길', '고개', 'mountain'],
  '꽃': ['꽃', '봄', '진달래', '목란', '벚꽃', '꽃보라', '만발', '꽃필', '향기', 'flower', 'spring', 'blossom'],
  '눈': ['눈', '겨울', '설경', '눈꽃', '눈보라', '함박눈', '서리', 'winter', 'snow'],
  '비': ['비', '빗물', '장마', '비바람', '소나기', '빗속', 'rain'],
  '사랑': [
    '사랑', '그대', '연인', '정든', '마음속', '사모', '연정', '첫사랑', '짝사랑', '당신', '님이여',
    '정다운', '설레', '두근', '연가', '세레나데', 'love', 'romance', 'darling', 'kiss',
  ],
  '조국': [
    '조국', '나라', '내나라', '고향', '강산', '금수강산', '어머니조국', '내조국', '삼천리', '통일',
    '겨레', '민족', '동포', '애국', '향토', '두만강', '압록강', '대동강', '모란봉',
  ],
  '혁명': [
    '혁명', '진군', '열병', '투쟁', '결전', '포성', '총대', '승리', '장군', '원수', '수령', '당기', '붉은기',
    '전사', '병사', '군대', '돌격', '격전', '전투', '함성', '기치', '사수', '진격', '항쟁', '봉기',
    '유격대', '빨치산', '포화', '총검', '군가', 'march', 'victory', 'soldier',
  ],
  '도시': ['도시', '거리', '평양', '려명', '불빛', '광장', '지하철', '전차', 'city'],
  '흥겨움': [
    '아리랑', '명절', '축제', '경사', '잔치', '춤', '노래자랑', '덩실', '신나', '흥겨', '환희',
    '경축', '축포', '노래하자', '춤추자', '만세', '환호', '박수', '웃음꽃', '풍년', '대풍',
